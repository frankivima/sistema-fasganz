    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav custom-navbar sidebar accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link btn-1" href="../views/index.php">
            ...
            ?>
                ...
                <!-- Nav Item - user -->
                <li class="nav-item">
                    <a class="nav-link btn-1" href="../views/usuarios.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed btn-1" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
            ...
            <!-- Nav Item - infor -->
            <li class="nav-item" title="NO DISPONIBLE || PRÓXIMAMENTE">
