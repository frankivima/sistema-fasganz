    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-5">
                        <form action="../_beneficiario/importar/leer.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-6">
                        ...
                        <em>· Las celdas que contienen fechas (columna <b>F</b>) deben estar en formato de fecha y tener valores válidos.</em> <br>
                        ...
                        <em>· El <b>Beneficiario</b> a registrar debe tener a su <b>Titular "Empleado"</b> previamente registrado en el sistema.</em> <br>
                        <em>· No se pueden registrar beneficiarios duplicados, es decir, la combinación de <b>cédula del empleado</b> y <b>cédula del beneficiario</b> no debe repetirse en el sistema.</em> <br>
                        <em>· No se pueden registrar múltiples beneficiarios con el mismo parentesco (Madre, Padre, Esposo(a), Concubino(a), Cónyuge) para un mismo empleado.</em> <br>
